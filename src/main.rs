        ...
        let launch_cmd = {
            let command = match &browser {
                ...
                Some(found) => {
                    ...
                    if !params.command.contains("--force-renderer-accessibility") {
